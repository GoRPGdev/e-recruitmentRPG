...
<div class="card" style="padding:36px 32px; text-align:center; max-width:580px; margin:40px auto; border-top:4px solid var(--good)">
	...
	<div class="eyebrow" style="color:var(--good); font-weight:700; margin-bottom:4px">Data Onboarding Terkirim</div>
	...
	<p class="muted" style="font-size:13.5px; line-height:1.6; margin-bottom:24px">
		Data kelengkapan onboarding untuk posisi <strong><?= html_escape($t['nama_posisi']) ?></strong> telah berhasil kami terima dan tersimpan secara aman di sistem Ratu Pertiwi Group.
	</p>
	...
	<div style="background:var(--surface-2); padding:16px 20px; border-radius:10px; text-align:left; font-size:13px; line-height:1.6; margin-bottom:24px; border:1px solid var(--border)">
		...
		<ul style="margin:0; padding-left:18px; color:var(--text-muted)">
			<li>Tim HR kami akan memverifikasi berkas dan rekening payroll yang telah Anda masukkan.</li>
			<li>Jadwal briefing hari pertama masuk kerja (day-1) dan surat perjanjian kerja akan diinformasikan oleh HR melalui WhatsApp atau Email resmi.</li>
		</ul>
	</div>
